...
public class EmberRootZoo {
  ...
  public void preInit(FMLPreInitializationEvent event) {
    ...
    EntityAncientGolem.ambientSound = registry.registerSound("ancientgolemambient");
    EntityAncientGolem.hurtSound = registry.registerSound("ancientgolemhurt");
    EntityAncientGolem.deathSound = registry.registerSound("ancientgolemdeath");

    EntityFairy.ambientSound = registry.registerSound("fairyambient");
    EntityFairy.hurtSound = registry.registerSound("fairyhurt");
    EntityFairy.deathSound = registry.registerSound("fairydeath");

    EntitySprout.ambientSound = registry.registerSound("sproutambient");
    EntitySprout.hurtSound = registry.registerSound("sprouthurt");
    EntitySprout.deathSound = registry.registerSound("sproutdeath");

    EntitySpriteProjectile.ambientSound = registry.registerSound("spriteprojectileambient");
    EntitySpriteProjectile.hurtSound = registry.registerSound("spriteprojectilehurt");
    EntitySpriteProjectile.deathSound = registry.registerSound("spriteprojectiledeath");
